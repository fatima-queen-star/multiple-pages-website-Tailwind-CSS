...
const HomeContent = () => {
  ...
  return (
      <section className="hero h-screen flex items-center bg-cover bg-center" style={{backgroundImage: "url('/watch-10-bg.jpg')"}}>
        <div className="pl-0 md:pl-16 text-white text-center">
            ...
            <p className="text-2x; my-4"> Your one-stop shop for the best watches </p>
